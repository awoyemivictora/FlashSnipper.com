...
async def ping_server(websocket):
    ...
    while True:
        try:
            ...
            logger.error(f"Error during keepalive ping: {e}")
            break   # Exit loop if the connection fails
                        ...
                        "tools": [
                            {
                                "type": "function",
                                "name": "use_browser",
                                "description": "Runs a browser-based task using an AI agent",
                                "parameters": {
                                    "type": "object",
                                    "properties": {
                                        "task": {
                                            "type": "string",
                                            "description": "The task description for the AI agent to execute",
                                        }
                                    },
                                    "required": ["task"],
                                },
