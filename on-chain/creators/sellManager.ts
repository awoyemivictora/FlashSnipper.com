...
// // Enhanced smart sells with advanced features:
...
//       // Use advanced orchestrator for selling
//       const orchestrator = new AdvancedBotOrchestrator(connection, request.user_wallet);
      
//       // Prepare bots for selling
//       const preparedBots = await orchestrator['prepareBotWallets'](request.bot_wallets.map(bot => ({
...
//       const exitInfo = await orchestrator['monitorForOptimalExit'](mint, monitoringTime);
      
//       console.log(`   Exit signal: ${exitInfo.exitSignal}`);
//       console.log(`   Reason: ${exitInfo.reason}`);
      
//       // Execute advanced selling strategy
//       const sellStrategy = orchestrator['determineSellStrategy'](exitInfo.exitSignal, exitInfo.peakPrice);
...
//           batchSize: sellStrategy.aggressiveness === 'aggressive' ? 3 : 1
//         }
//       );
...
//         console.log(`💰 Starting auto-sell strategy...`);
//         const sellResult = await executeAdvancedSmartSells(connection, sellRequest);
